// Generic Small Wreckage Library
// Subject to the terms of the World Builder License.

#ifndef GENERIC_SMALL_WRECKAGE_INCLUDES_H_
#define GENERIC_SMALL_WRECKAGE_INCLUDES_H_

// Argh's Small Wreckage Script
...
#endif // if GENERIC_SMALL_WRECKAGE_INCLUDES_H_